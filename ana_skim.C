void ana_skim(TString discriminant = "CSVM", bool isMC = false) {
  ...
  //chain.Add("/eos/uscms/store/user/lpcpjm/SusyNtuples/cms538v0p1/Run2012B-22Jan2013-v1/DoublePhoton/susyEvents_1*.root");
  chain.Add("/eos/uscms/store/user/lpcpjm/SusyNtuples/cms538v0p1/Run2012C-22Jan2013-v2/DoublePhoton/susyEvents_16*.root");
  chain.Add("/eos/uscms/store/user/lpcpjm/SusyNtuples/cms538v0p1/Run2012C-22Jan2013-v2/DoublePhoton/susyEvents_17*.root");
  chain.Add("/eos/uscms/store/user/lpcpjm/SusyNtuples/cms538v0p1/Run2012C-22Jan2013-v2/DoublePhoton/susyEvents_18*.root");
  chain.Add("/eos/uscms/store/user/lpcpjm/SusyNtuples/cms538v0p1/Run2012C-22Jan2013-v2/DoublePhoton/susyEvents_19*.root");
