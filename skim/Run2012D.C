void Run2012D(TString discriminant = "CSVM", bool isMC = false) {
  ...
  chain.Add("/eos/uscms/store/user/lpcpjm/SusyNtuples/cms538v0p1/Run2012D-22Jan2013-v1/DoublePhoton/susyEvents_SOURCE_NUMBER*.root");
  ...
  sea->SetOutput("Run2012D-22Jan2013-DoublePhoton_SOURCE_NUMBER");
