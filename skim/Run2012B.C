void Run2012B(TString discriminant = "CSVM", bool isMC = false) {
  ...
  //chain.Add("/eos/uscms/store/user/lpcpjm/SusyNtuples/cms538v0p1/Run2012C-22Jan2013-v2/DoublePhoton/*.root");
  ...
  sea->SetOutput("Run2012B-22Jan2013-DoublePhoton_SOURCE_NUMBER");
