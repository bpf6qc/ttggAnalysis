void ana_signal(TString scan = "stop-bino", TString discriminant = "CSVM", bool isMC = true, bool isFastSim = true) {
  ...
  if(scan == "stop-bino") sprintf(input_file, "dcap:///pnfs/cms/WAX/resilient/lpcpjm/PrivateMC/FastSim/533p3_full/naturalBinoNLSP_try5/SusyNtuple/cms533v1_v1/tree_naturalHiggsinoNLSPout_mst_%d_M3_5050_mu_%d.root", index1, index2);
  ...
  chain.Add("/eos/uscms/store/user/bfrancis/stop-bino_460_175.root");
