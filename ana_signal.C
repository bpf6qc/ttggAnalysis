void ana_signal(TString scan = "stop-bino", TString discriminant = "CSVM", bool isMC = true, bool isFastSim = true) {
  ...
  if(scan == "stop-bino") sprintf(input_file, "dcap:///pnfs/cms/WAX/resilient/lpcpjm/SusyNtuples/cms538v1/naturalBinoNLSP/tree_naturalHiggsinoNLSPout_mst_%d_M3_5050_M1_%d.root", index1, index2);
